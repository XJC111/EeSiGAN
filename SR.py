...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', help='input image dir', default='G:\\Desktop\\xue\\GAN\\MFCN-DIVA\\SinGAN-master\\Input\\Images')
    parser.add_argument('--input_name', help='training image name', default="balloons.png")#required=True)
